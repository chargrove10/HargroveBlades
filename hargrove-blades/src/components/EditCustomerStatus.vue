...
<div class="form-div">
    ...
    <div class="tab-div2" style="min-height:auto;width:87.35% ;transform:translatex(3%)">
        <div style="border: thin solid black" v-for="cStatus in CStatus" :key="cStatus.CustomerStatusID">
            ...
            <div>
                ...
                <button style="transform:translate(330%,0)" v-on:click="editCustomerStatus()">Save</button>    
            </div> 
