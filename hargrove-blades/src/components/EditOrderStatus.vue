...
<div class="form-div">
    ...
    <div class="tab-div2" style="min-height:auto">
        <div style="background-color: lightgrey" v-for="orStatus in OrStatus" :key="orStatus.OrderStatusID">
            ...
            <div>
                ...
                <button style="transform:translate(90%,0)" v-on:click="editOrderStatus()">Save</button>  
            </div> 
