        ...
        <div class="tab-div1">
         ...
         <div class="tab-div2" style="min-height:auto">
            ...
            <div class="tabcontent" style="display:block">
                <div style="background-color:lightgray; text-align:center"><header>Product Status Information</header></div>
...
export default {
        ...
        created() {
            ...
            axios.get('http://localhost:3000/productStatus').then((res) => {
