...
<div class="form-div">
    ...
    <div style="color: white; text-align:center;margin-bottom:20px">
        <header>Add New Order Status</header>
    </div>
    ...
    <div class="tab-div2" style="min-height:auto;width:87.35% ;transform:translatex(3%)">
        <div style="border: thin solid black">
            ...
            <div>
                ...
                <button style="transform:translate(330%,0)" v-on:click="addOrderStatus()">Save</button>  
            </div> 
    ...
    export default {
        ...
        methods: {
            ...
            addOrderStatus(){
                ...
                let url = 'http://localhost:3000/addOrderStatus'

                let vm = this

                axios.post(url, vm.orStatus).then(() =>{
